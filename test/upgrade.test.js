...
function fixture(version='0.1.1') {
  ...
  const next={...old,'package.json':JSON.stringify({name:'openclaw-arxiv-daily',version:'0.5.1'}),
...
test('upgrade accepts a clean public installation and an interrupted mix of known old/new files without touching state', t=>{
  for(const version of ['0.1.0','0.1.1','0.2.0','0.3.0','0.3.1','0.3.2','0.4.0','0.5.0']){
